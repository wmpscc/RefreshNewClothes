...
public class DisplayFirstBannerFragment extends Fragment {
    ...
    public static DisplayFirstBannerFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_display_first_banner, container, false);
    }
