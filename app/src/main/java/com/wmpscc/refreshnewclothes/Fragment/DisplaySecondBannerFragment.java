...
public class DisplaySecondBannerFragment extends Fragment {
    ...
    public static DisplaySecondBannerFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_display_second_banner, container, false);
    }
