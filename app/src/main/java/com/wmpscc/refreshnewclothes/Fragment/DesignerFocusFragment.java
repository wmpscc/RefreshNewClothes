...
public class DesignerFocusFragment extends Fragment {
    ...
    public DesignerFocusFragment() {
        // Required empty public constructor
    }


    public static DesignerFocusFragment newInstance(String param1, String param2) {
        DesignerFocusFragment fragment = new DesignerFocusFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_designer_focus, container, false);
        analyzeJson();
        initView();
        initRecycleItem();
        return mView;
    ...
    private void initView() {
        mRecyclerView = mView.findViewById(R.id.rv_designer_focus);
